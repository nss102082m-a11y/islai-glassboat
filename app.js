...
const I18N = {
  ja: {
    ...
    aboutTitle: "About",
    aboutMsg: "本アプリは BLUE CORAL 提供の ISLAI プロトタイプです。",
    settingsTitle: "設定",
    settingsLang: "言語",
  ...
  en: {
    ...
    aboutTitle: "About",
    aboutMsg: "This app is an ISLAI prototype by BLUE CORAL.",
  ...
  "zh-CN": {
    ...
    aboutTitle: "关于",
    aboutMsg: "本应用为 BLUE CORAL 提供的 ISLAI 原型。",
    settingsTitle: "设置",
    settingsLang: "语言",
  ...
  "zh-TW": {
    ...
    aboutTitle: "About",
    aboutMsg: "本應用為 BLUE CORAL 提供之 ISLAI 原型。",
    settingsTitle: "設定",
    settingsLang: "語言",
  ...
  ko: {
    ...
    aboutTitle: "About",
    aboutMsg: "본 앱은 BLUE CORAL이 제공하는 ISLAI 프로토타입입니다.",
    settingsTitle: "설정",
    settingsLang: "언어",
...
function bindGuideAudio() {
  ...
  const src = pickAudioByLang(getLang());
